dp.sh.Brushes.Lua = function()
{
	...
	var splay_funcs	=	'events.loop events.thread events.periodic events.dead' +
		...
		' events.lock events.semaphore events.stats events.run' +
		' rpc.server rpc.call rpc.a_call rpc.acall rpc.ecall rpc.ping rpc.proxy' +
		' urpc.server urpc.call urpc.a_call urp.acall urpc.ecall urpc.ping urpc.proxy' +
		' rpcq.server rpcq.call rpcq.a_call urp.acall rpcq.ecall rpcq.ping rpcq.proxy' +
